...
> - **Nessun SMTP configurato** (`emailConfigured: false`): niente email di invito o reset password. Accettabile con un solo amministratore; da rivedere se si aggiungono altri utenti umani all'organizzazione.
